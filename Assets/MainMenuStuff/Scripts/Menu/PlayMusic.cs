...
public class PlayMusic : MonoBehaviour {
	...
	public AudioMixerSnapshot volumeDown;			//Reference to Sound mixer snapshot in which the master volume of main mixer is turned down
	public AudioMixerSnapshot volumeUp;				//Reference to Sound mixer snapshot in which the master volume of main mixer is turned up
